...
export function Dashboard({
  ...
  return (
    <div>
      ...
      {txFormOpen && (
        <TxForm tx={null} categories={categories} transactionHistory={transactions} activeUserId={activeUserId} onSave={(tx) => { onAddTx(tx); setTxFormOpen(false); }} onTransfer={async (data) => { if (await onTransferEnvelope(data.fromId, data.toId, data.amount, data.description)) setTxFormOpen(false); }} onCancel={() => setTxFormOpen(false)} styles={styles} />
      )}
